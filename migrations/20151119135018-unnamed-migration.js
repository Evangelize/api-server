    ...
    return Promise.all([
      queryInterface.createTable(
        'people',
        {
          ...
          nonChristian: { type: Sequelize.BOOLEAN, defaultValue: false },
          nonMember: { type: Sequelize.BOOLEAN, defaultValue: false },
          membershipStatus: Sequelize.STRING(1),
          deceased: { type: Sequelize.BOOLEAN, defaultValue: false },
          collegeStudent: { type: Sequelize.BOOLEAN, defaultValue: false },
